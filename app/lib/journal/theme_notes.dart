...
class ThemeNotes {
  ...
  /// Все заметки — по ним справочник отбирает свои реалии (T24). Читается
  /// из кэша: после правки в листе список обновляется, не перечитывая журнал.
  Map<String, String> get all => Map.unmodifiable(_byTheme);
